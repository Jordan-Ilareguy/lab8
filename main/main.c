...
#define I2C_MASTER_FREQ_HZ     400000  // 400 kHz I2C speed (more robust while debugging)
...
void app_main()
{
    ...
    i2c_send_data_block(SLAVE_ADDR, wake, sizeof(wake));
    ...
    if (ret == ESP_OK)
    {
        ...
        esp_err_t ret_read = i2c_read_bytes(SLAVE_ADDR, data_to_send[0], read_buffer, 1);
